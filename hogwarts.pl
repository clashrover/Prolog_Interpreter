...
married(A,B) :- marry(A,B).
married(A,B) :- marry(B,A).

mother(A,B) :- parent(A,B), female(A).
father(A,B) :- parent(A,B), male(A).
husband(A,B) :- married(A,B), male(A).
wife(A,B) :- married(A,B),female(A).
brother(A,B) :- male(A), sibling(A,B).
sister(A,B) :- female(A), sibling(A,B).
halfbrother(A,B) :- male(A), halfsibling(A,B).
halfsister(A,B) :- female(A), halfsibling(A,B).
stepbrother(A,B) :- male(A), stepsibling(A,B).
